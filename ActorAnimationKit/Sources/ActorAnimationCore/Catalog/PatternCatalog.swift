...
public enum PatternCatalog {
    public static let patterns: [AnimationPattern] = [
    ...
    public static func pattern(forID id: String) -> AnimationPattern? {
        patterns.first { $0.id == id }
    }

    public static func filter(searchText: String, category: AnimationCategory?) -> [AnimationPattern] {
